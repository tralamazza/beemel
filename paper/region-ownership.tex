...
\emph{independently documented} for chips it was not co-designed with
(\S\ref{sec:eval-catalog}); a controlled counterfactual reproduced on hardware
(\S\ref{sec:eval-counterfactual}); and end-to-end bring-ups on three boards
(\S\ref{sec:eval-boards}). The first directly addresses the central threat to an
experience paper --- that the checks were exercised only on the programs they
were built against.
